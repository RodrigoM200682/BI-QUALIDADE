...
LAST_DIR = Path("data/qualidade/.last_input")
...
COR_BORDA = "#D7E1D7"
COR_SIDEBAR = "#EEF4EA"
LOGO_FILE = Path("assets/logo_brasilata.png")
DEFAULT_DATA_FILE = Path("data/qualidade/Consultas_RNC_APP.xlsx")
MANUAL_FILE = Path("manual/Manual_BI_Qualidade_Corporativo_RM_2026.pdf")
